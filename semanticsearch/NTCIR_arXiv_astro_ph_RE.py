...
def get_formula_catalog():
    ...
    with open(filepath + "NTCIR-12_arXiv_astro-ph-Formula_Catalog.pkl", "rb") as f:
...
def create_formula_catalog():
    ...
    for file in os.listdir(filepath):
        if file.endswith("tei"):# and file_counter < 25:
            print(file)
            file_counter += 1
            print(file_counter)
            with open("" + file,"r",encoding="utf8") as f:
                ...
                formulae = soup.find_all("formula")
                for formula in formulae:
                    ...
                    try:
                        ...
                        identifiers = soup.find_all("m:mi")
    ...
    with open("NTCIR-12_arXiv_astro-ph-Formula_Catalog.pkl", "wb") as f:
        pickle.dump(Formula_Catalog,f)

# EXECUTIONS

#formula_catalog = get_formula_catalog()
#identifier_semantics_catalog = get_identifier_semantics_catalog(inverse=True,multiple=True)
